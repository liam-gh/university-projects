...
This game runs on the "KePoCo", a Raspberry Pi Pico

</div>

<div align="left">

![Date](https://img.shields.io/badge/Date-5th%20December%202025-red)
...
![Grade](https://img.shields.io/badge/Grade-65%-green)
...
| Script | Purpose |
|--------|---------|
| `liam.py` | My AI, which features a depth-2 minimax algorithm |
